...
export default function Standings() {
  ...
  useEffect(() => {
    const fetchLeagues = async () => {
      try {
        const res = await axios.get("https://disabled-moira-sagesse123-5f6de789.koyeb.app/api/v1/leagues");
  ...
  const fetchStandings = async () => {
    try {
      ...
      const res = await axios.get(
        `https://disabled-moira-sagesse123-5f6de789.koyeb.app/api/v1/leagues/${selectedLeague}/standings`
      );
